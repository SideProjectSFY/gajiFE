...
<template>
  <div :class="css({ minH: '100vh', display: 'flex', flexDirection: 'column', bg: 'gray.50' })">
    ...
    >
      <!-- Breadcrumb -->
      <div :class="css({ maxW: '1200px', w: 'full', mb: '8' })">
        <div
          :class="
            css({
              display: 'flex',
        ...
        >
          ...
          >
          <span>›</span>
          <span :class="css({ color: 'green.600', fontWeight: '500' })">About</span>
        </div>
      </div>
      ...
      <div :class="css({ maxW: '1200px', w: 'full' })">
        ...
        <!-- Get Started Section -->
        <div
          :class="css({ bg: 'white', borderRadius: '1rem', p: { base: '8', md: '12' }, mb: '12' })"
        >
          <h2
            :class="
              css({
